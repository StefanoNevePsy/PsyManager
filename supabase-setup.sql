...
-- =============================================================================
-- STATO FATTURAZIONE — quali sedute sono già state fatturate
-- Una ricevuta può coprire più sedute (receipt_sessions); le sedute pagate in
-- contanti non richiedono fattura.
-- =============================================================================
